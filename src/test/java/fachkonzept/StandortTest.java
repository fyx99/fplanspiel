...
public class StandortTest {
    ...
    void faktoren() {
		...
		assertEquals(1.0, unNeutral.getStandort().getAngebotsAttraktivitaet());
		...
		assertEquals(1.03, unA.getStandort().getAngebotsAttraktivitaet());
		...
		assertEquals(1.0, unB.getStandort().getAngebotsAttraktivitaet());
		...
		assertEquals(1.03, unC.getStandort().getAngebotsAttraktivitaet());
		...
		assertEquals(1.0, unD.getStandort().getAngebotsAttraktivitaet());
